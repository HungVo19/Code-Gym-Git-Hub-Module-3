...
CREATE TABLE `ordersdetails` (
  ...
  PRIMARY KEY (`oID`,`pID`),
  KEY `pID` (`pID`),
  CONSTRAINT `ordersdetails_ibfk_1` FOREIGN KEY (`oID`) REFERENCES `orders` (`oID`),
  CONSTRAINT `ordersdetails_ibfk_2` FOREIGN KEY (`pID`) REFERENCES `product` (`pID`)
...
INSERT INTO `ordersdetails` VALUES (1,1,3),(1,3,7),(1,4,2),(2,1,1),(2,3,8),(2,5,4),(3,1,8);
...
-- Dump completed on 2022-11-18  8:48:43
